...
<!-- Modal -->
<div class="modal fade" id="noticsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">Important information</h5>
      ...
      <div class="modal-body">
            ...
            <div class="card-body">
                    ...
                    <fieldset>
                      ...
                      <div >
                      <h3 ><p style="color: red;">Important information....</p></h3>
                      <hr>
